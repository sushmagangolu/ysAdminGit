...
var table = $("#datatable-buttons").DataTable({
    ...
    buttons: [{
        ...
        "bSortCellsTop": true,
        "iDisplayLength": 10,
    "ajax": "inc/service.php?action=get_leads_all",
    "columns": [{
            "title": 'Name',
...
inputs += '<td><input type="text" placeholder="Client" class="form-control input-sm"></td>';
