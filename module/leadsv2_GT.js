...
inputs += '<td><input type="text" placeholder="City" class="form-control input-sm"></td>';
        ...
        $.getJSON("inc/service.php?action=getRemarks&leadId=" + id, function(logs) {
            if (logs != 0) {
                $.each(logs, function(i, log) {
                    var taskList = '<tr><td style="line-height:1">';                    if(log.remark_type == 'audio') {
